...
const (
	Foobar_AFoo_FullMethodName        = "/wombat.v1.Foobar/AFoo"
	Foobar_Baz_FullMethodName         = "/wombat.v1.Foobar/Baz"
	Foobar_Bar_FullMethodName         = "/wombat.v1.Foobar/Bar"
	Foobar_Foo_FullMethodName         = "/wombat.v1.Foobar/Foo"
	Foobar_Empty_FullMethodName       = "/wombat.v1.Foobar/Empty"
	Foobar_WellKnown_FullMethodName   = "/wombat.v1.Foobar/WellKnown"
	Foobar_SingleOneof_FullMethodName = "/wombat.v1.Foobar/SingleOneof"
)
...
func (c *foobarClient) AFoo(ctx context.Context, in *AFooRequest, opts ...grpc.CallOption) (*AFooResponse, error) {
	...
	err := c.cc.Invoke(ctx, Foobar_AFoo_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *foobarClient) Baz(ctx context.Context, in *BazRequest, opts ...grpc.CallOption) (*BazResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(BazResponse)
	err := c.cc.Invoke(ctx, Foobar_Baz_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *foobarClient) Bar(ctx context.Context, in *BarRequest, opts ...grpc.CallOption) (*BarResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(BarResponse)
	err := c.cc.Invoke(ctx, Foobar_Bar_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *foobarClient) Foo(ctx context.Context, in *FooRequest, opts ...grpc.CallOption) (*FooResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(FooResponse)
	err := c.cc.Invoke(ctx, Foobar_Foo_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *foobarClient) Empty(ctx context.Context, in *EmptyRequest, opts ...grpc.CallOption) (*EmptyResponse, error) {
	...
	err := c.cc.Invoke(ctx, Foobar_Empty_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *foobarClient) WellKnown(ctx context.Context, in *WellKnownRequest, opts ...grpc.CallOption) (*WellKnownResponse, error) {
	...
	err := c.cc.Invoke(ctx, Foobar_WellKnown_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *foobarClient) SingleOneof(ctx context.Context, in *SingleOneofRequest, opts ...grpc.CallOption) (*SingleOneofResponse, error) {
	...
	err := c.cc.Invoke(ctx, Foobar_SingleOneof_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
// UnimplementedFoobarServer must be embedded to have
...
func (UnimplementedFoobarServer) testEmbeddedByValue()                {}
...
func RegisterFoobarServer(s grpc.ServiceRegistrar, srv FoobarServer) {
	// If the following call pancis, it indicates UnimplementedFoobarServer was
...
func _Foobar_AFoo_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Foobar_AFoo_FullMethodName,
	}
...
func _Foobar_Baz_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Foobar_Baz_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Foobar_Bar_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Foobar_Bar_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Foobar_Foo_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Foobar_Foo_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Foobar_Empty_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Foobar_Empty_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Foobar_WellKnown_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Foobar_WellKnown_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Foobar_SingleOneof_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Foobar_SingleOneof_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
