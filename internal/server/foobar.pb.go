...
type FooRequest struct {
	...
	TypeStringMap  map[string]string      `protobuf:"bytes,18,rep,name=type_string_map,json=typeStringMap,proto3" json:"type_string_map,omitempty" protobuf_key:"bytes,1,opt,name=key" protobuf_val:"bytes,2,opt,name=value"`
	TypeComplexMap map[string]*Bar        `protobuf:"bytes,19,rep,name=type_complex_map,json=typeComplexMap,proto3" json:"type_complex_map,omitempty" protobuf_key:"bytes,1,opt,name=key" protobuf_val:"bytes,2,opt,name=value"`
	unknownFields  protoimpl.UnknownFields
	sizeCache      protoimpl.SizeCache
}
...
func (x *BazRequest) GetRequest() isBazRequest_Request {
	if x != nil {
		return x.Request
	}
	return nil
...
func (x *BazRequest) GetFoo() *FooRequest {
	if x != nil {
		if x, ok := x.Request.(*BazRequest_Foo); ok {
			return x.Foo
		}
	}
	return nil
...
func (x *BazRequest) GetBar() *BarRequest {
	if x != nil {
		if x, ok := x.Request.(*BazRequest_Bar); ok {
			return x.Bar
		}
	}
	return nil
...
func (x *BazRequest) GetBaz() string {
	if x != nil {
		if x, ok := x.Request.(*BazRequest_Baz); ok {
			return x.Baz
		}
	}
	return ""
...
type AFooRequest struct {
	state           protoimpl.MessageState `protogen:"open.v1"`
	MapStringString map[string]string      `protobuf:"bytes,1,rep,name=map_string_string,json=mapStringString,proto3" json:"map_string_string,omitempty" protobuf_key:"bytes,1,opt,name=key" protobuf_val:"bytes,2,opt,name=value"`
	MapInt32Bytes   map[int32][]byte       `protobuf:"bytes,2,rep,name=map_int32_bytes,json=mapInt32Bytes,proto3" json:"map_int32_bytes,omitempty" protobuf_key:"varint,1,opt,name=key" protobuf_val:"bytes,2,opt,name=value"`
	MapStringEnum   map[string]Baz         `protobuf:"bytes,3,rep,name=map_string_enum,json=mapStringEnum,proto3" json:"map_string_enum,omitempty" protobuf_key:"bytes,1,opt,name=key" protobuf_val:"varint,2,opt,name=value,enum=wombat.v1.Baz"`
	MapStringBool   map[string]bool        `protobuf:"bytes,4,rep,name=map_string_bool,json=mapStringBool,proto3" json:"map_string_bool,omitempty" protobuf_key:"bytes,1,opt,name=key" protobuf_val:"varint,2,opt,name=value"`
	MapInt32Message map[int32]*BazRequest  `protobuf:"bytes,5,rep,name=map_int32_message,json=mapInt32Message,proto3" json:"map_int32_message,omitempty" protobuf_key:"varint,1,opt,name=key" protobuf_val:"bytes,2,opt,name=value"`
	unknownFields   protoimpl.UnknownFields
	sizeCache       protoimpl.SizeCache
}
...
func (x *SingleOneofRequest) GetFoobar() isSingleOneofRequest_Foobar {
	if x != nil {
		return x.Foobar
	}
	return nil
...
func (x *SingleOneofRequest) GetBaz() *WellKnownResponse {
	if x != nil {
		if x, ok := x.Foobar.(*SingleOneofRequest_Baz); ok {
			return x.Baz
		}
	}
	return nil
...
var file_foobar_proto_rawDesc = string([]byte{
...
var (
	...
	file_foobar_proto_rawDescData []byte
)

func file_foobar_proto_rawDescGZIP() []byte {
	file_foobar_proto_rawDescOnce.Do(func() {
		file_foobar_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_foobar_proto_rawDesc), len(file_foobar_proto_rawDesc)))
	})
...
var file_foobar_proto_goTypes = []any{
...
func file_foobar_proto_init() {
	...
	file_foobar_proto_msgTypes[5].OneofWrappers = []any{
		(*BazRequest_Foo)(nil),
		(*BazRequest_Bar)(nil),
		(*BazRequest_Baz)(nil),
	}
	file_foobar_proto_msgTypes[13].OneofWrappers = []any{
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_foobar_proto_rawDesc), len(file_foobar_proto_rawDesc)),
			NumEnums:      1,
			NumMessages:   23,
			NumExtensions: 0,
			NumServices:   1,
